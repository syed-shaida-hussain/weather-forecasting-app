...
export const WeatherCard = () => {
  ...
  return (
    ...
    <div className='text-center flex flex-col gap-15'>
      ...
      <img src = {`https://openweathermap.org/img/wn/${currentWeather?.weather[0]?.icon}@2x.png`} alt='weather condition icon' width={90} height={90} className='text-center m-auto' />
